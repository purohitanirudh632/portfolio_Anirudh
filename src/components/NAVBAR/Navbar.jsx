...
const Navbar = () => {
  ...
  return (
    <div className='navbar'>
      <img src={Ani_icon} className='icon' alt="" />
      ...
      <div className="nav-connect"><AnchorLink className='anchor-link' offset={50} href='#footer'>Connect with Network</AnchorLink></div>
    </div>
  )
}
